...
- Playbook archive (release): `jarvisos_v1.0.0.zip` (also published to Releases)
...
- `jarvisos_v1.0.0.zip` — packaged playbook archive (ready for upload).
...
3. Upload to AME Beta
	...
	- Use the AME Beta UI or import mechanism and choose `jarvisos_v1.0.0.zip`.
...
- To rebuild the ZIP locally:
  ...
  ```bash
  zip -r jarvisos_v1.0.0.zip my-playbook
  sha256sum jarvisos_v1.0.0.zip
  ```
...
- A release `v1.0.0` was created and the archive uploaded. To recreate or add assets, you can use the GitHub CLI:
  ...
  ```bash
  gh release upload v1.0.0 jarvisos_v1.0.0.zip --clobber
  ```
